...
export default function Index() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Вы получаете чистую криптовалюту с различных источников, не связанных с вашей начальной транзакцией. Эти монеты безопасно отправлять на биржи и обменники без риска блокировки.",
    },
    {
  ...
  return (
    <div className="relative bg-biteco-bg text-biteco-text">
      ...
      <div className="absolute top-0 left-0 right-0 h-[933px] overflow-hidden pointer-events-none">
        ...
        />
        <img
          src="https://cdn.builder.io/api/v1/image/assets%2F47d074b0ca244187b332ed361409a2c5%2Fdcb2435042d945b69ee3763b158ea602?format=webp&width=800"
          alt=""
          className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-[1920px] h-auto opacity-100 pointer-events-none"
        />
      </div>
